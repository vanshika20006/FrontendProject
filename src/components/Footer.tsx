    ...
    >
      <div className="container max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 mb-12">
          ...
          {/* Added lg:pl-48 to preserve desktop, used grid-cols-2 for mobile/tablet */}
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-2 gap-x-8 gap-y-10 lg:gap-x-20 lg:gap-y-8 lg:pl-48">
